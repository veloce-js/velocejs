...
// ../../node_modules/.pnpm/github.com+uNetworking+uWebSockets.js@a58e810e47a2_b2f067d67104bfeb42092bc657ccad18/node_modules/uWebSockets.js/uws.js
var require_uws = __commonJS({
  "../../node_modules/.pnpm/github.com+uNetworking+uWebSockets.js@a58e810e47a2_b2f067d67104bfeb42092bc657ccad18/node_modules/uWebSockets.js/uws.js"(exports, module2) {
    module2.exports = (() => {
      try {
        return require("./uws_" + process.platform + "_" + process.arch + "_" + process.versions.modules + ".node");
      } catch (e) {
        throw new Error("This version of \xB5WS is not compatible with your Node.js build:\n\n" + e.toString());
      }
    })();
  }
});
...
var import_uWebSockets2 = __toModule(require_uws());

// src/create-app.ts
var import_uWebSockets = __toModule(require_uws());
function createApp(opt) {
  return opt ? import_uWebSockets.default.SSLApp(opt) : import_uWebSockets.default.App();
}

// src/read-json-async.ts
    ...
    return new Promise((resolver, rejecter) => {
      ...
      res.onData((ab, isLast) => {
        ...
        if (isLast) {
          ...
          if (buffer) {
            try {
              json = JSON.parse(bconcat([buffer, chunk], true));
            } catch (e) {
              res.close();
              return rejecter(e);
            }
...
function serveStatic(assetDir) {
  return function(res, req) {
    ...
    const file = import_fs.default.readFileSync(import_path.default.join(assetDir, url));
    if (file) {
      const mimeType = import_mime_types.default.lookup(url) || "application/octet-stream";
...
// index.ts
var server_default = import_uWebSockets2.default;
