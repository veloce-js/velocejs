...
`);
  ...
  var CONTRACT_REQUEST_METHOD = "get";
  var VeloceClient = class {
    ...
    _getContract() {
      return __async(this, null, function* () {
        return this._transportFn(this._options.host + this._options.contractUrl, CONTRACT_REQUEST_METHOD).then((json) => new import_reader.JsonqlContractReader(json));
      });
    }
  ...
  function f(url, method, params, options) {
    return __async(this, null, function* () {
      ...
      return fetch(url, options ? Object.assign(opts, options) : opts).then((res) => res.json());
    });
  }
